...
public class StudentController {
	...
	public ResponseEntity<Student> findById(@PathVariable Long matricula) {
	...
	public ResponseEntity<?> update(@PathVariable Long matricula, @RequestBody Student newStudent) {
